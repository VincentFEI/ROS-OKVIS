...
//Modified by ZPF
//Add MSGXYZ
//Add MSG IMUData including measure_imu_acc & measure_imu_acc_covar and so on
//Modified by ZPF
//Modified by ZPF
...
public:
    RobotAbstract()
    {
        ...
        //Modified by ZPF
        //**************
	//measure_imu_original_data.imu_state = 0;
	
        measure_imu_original_data.measure_imu_acc.x=0;
        measure_imu_original_data.measure_imu_acc.y=0;
        measure_imu_original_data.measure_imu_acc.z=0;

        measure_imu_original_data.measure_imu_acc_covar.x=0;
        measure_imu_original_data.measure_imu_acc_covar.y=0;
        measure_imu_original_data.measure_imu_acc_covar.z=0;

        measure_imu_original_data.measure_imu_gyro.x=0;
        measure_imu_original_data.measure_imu_gyro.y=0;
        measure_imu_original_data.measure_imu_gyro.z=0;

        measure_imu_original_data.measure_imu_gyro_covar.x=0;
        measure_imu_original_data.measure_imu_gyro_covar.y=0;
        measure_imu_original_data.measure_imu_gyro_covar.z=0;
    ...
    struct MSG_IMUData{
	//int       imu_state;
        MSGXYZ    measure_imu_acc;
        MSGXYZ    measure_imu_acc_covar;
        MSGXYZ    measure_imu_gyro;
        MSGXYZ    measure_imu_gyro_covar;
    }measure_imu_original_data;
    /************************************system info***************************************/
